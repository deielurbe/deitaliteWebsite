...
const translations = {
  en: {
    ...
    'faq.q4.answer': '<strong>Typically within 15–20% of actual sales, 80% of the time.</strong> The goal isn\'t to hit exact numbers. It\'s to reduce waste, avoid stockouts, and spot unusual days before they happen. Accuracy improves with more history.',
  ...
  nl: {
    ...
    'faq.q4.answer': '<strong>Meestal binnen 15–20% van de werkelijke verkoop, 80% van de tijd.</strong> Het doel is niet exacte getallen raken. Het is derving verminderen, uitverkocht voorkomen en ongewone dagen van tevoren signaleren. Nauwkeurigheid verbetert met meer historie.',
  ...
  es: {
    ...
    'faq.q4.answer': '<strong>Típicamente dentro del 15–20% de las ventas reales, el 80% del tiempo.</strong> El objetivo no es acertar números exactos. Es reducir mermas, evitar roturas de stock y detectar días inusuales antes de que ocurran. La precisión mejora con más historial.',
