...
const translations = {
  en: {
    ...
    'features.item2.title': '14-day rolling forecast',
    'features.item2.text': '14 days ahead, updated every morning. Days 1–7 with full weather detail. Days 8–14 blended with seasonal patterns. We show you when the forecast is less certain, because honest beats optimistic.',
    'features.item3.title': 'Busy vs quiet highlights',
    'features.item3.text': 'See when a day looks different from your typical Tuesday or Saturday. Dishes trending up or down over recent weeks get flagged, so you catch the shift before it catches you.',
    ...
    'proof.subtitle': 'Your daily email shows item quantities for the next 14 days, updated with fresh weather data every morning.',
    ...
    'proof.callout3.title': 'Trends flagged automatically',
    'proof.callout3.text': 'Your Caesar Salad outselling predictions for 4 weeks? That\'s not noise. That\'s a trend. We flag it so you adjust before waste catches up.',
    ...
    'faq.q3.answer': '<strong>Check email → see quantities → share with team. 30 seconds.</strong> Most restaurants check once a day or a few times a week. You see the next 14 days, adjust prep/ordering/staffing accordingly. It\'s a quick check, not a system to manage.',
    ...
    'start.what.item1': '<strong>Daily forecasts:</strong> demand predictions for the next 14 days, delivered at 7am.',
  ...
  nl: {
    ...
    'features.item2.title': 'Doorlopende 14-daagse forecast',
    'features.item2.text': '14 dagen vooruit, elke ochtend bijgewerkt. Dag 1–7 met volledig weerdetail. Dag 8–14 gemengd met seizoenspatronen. We laten zien wanneer de forecast minder zeker is, want eerlijk is beter dan optimistisch.',
    'features.item3.title': 'Druk vs rustig highlights',
    'features.item3.text': 'Zie wanneer een dag afwijkt van je normale dinsdag of zaterdag. Gerechten die de afgelopen weken stijgen of dalen worden gesignaleerd, zodat je de verschuiving opvangt voor hij jou opvangt.',
    ...
    'proof.subtitle': 'Je dagelijkse email toont aantallen per gerecht voor de komende 14 dagen, elke ochtend bijgewerkt met verse weerdata.',
    ...
    'proof.callout3.title': 'Trends automatisch gesignaleerd',
    'proof.callout3.text': 'Je Caesar Salade verkoopt al 4 weken boven verwachting? Dat is geen ruis. Dat is een trend. We signaleren het zodat je bijstuurt voor de verspilling je inhaalt.',
    ...
    'faq.q3.answer': '<strong>Check email → zie aantallen → deel met team. 30 seconden.</strong> De meeste restaurants checken één keer per dag of een paar keer per week. Je ziet de komende 14 dagen, past prep, inkoop en rooster daarop aan. Het is een snelle check, geen systeem om te beheren.',
    ...
    'start.what.item1': '<strong>Dagelijkse forecasts:</strong> vraagvoorspellingen voor de komende 14 dagen, geleverd om 7 uur.',
  ...
  es: {
    ...
    'features.item2.title': 'Previsión continua de 14 días',
    'features.item2.text': '14 días por delante, actualizado cada mañana. Días 1–7 con detalle meteorológico completo. Días 8–14 combinados con patrones estacionales. Te mostramos cuándo la previsión es menos segura, porque honesto supera a optimista.',
    'features.item3.title': 'Destacados de días fuertes vs flojos',
    'features.item3.text': 'Ve cuando un día difiere de tu martes o sábado típico. Los platos con tendencia al alza o a la baja en las últimas semanas se señalan, para que detectes el cambio antes de que te pille.',
    ...
    'proof.subtitle': 'Tu email diario muestra cantidades por plato para los próximos 14 días, actualizado con datos meteorológicos frescos cada mañana.',
    ...
    'proof.callout3.title': 'Tendencias señaladas automáticamente',
    'proof.callout3.text': '¿Tu Ensalada César vendiendo por encima de las previsiones 4 semanas seguidas? Eso no es ruido. Es una tendencia. Lo señalamos para que ajustes antes de que la merma te alcance.',
    ...
    'faq.q3.answer': '<strong>Revisar email → ver cantidades → compartir con el equipo. 30 segundos.</strong> La mayoría de restaurantes consultan una vez al día o un par de veces por semana. Ves los próximos 14 días, ajustas prep, compras y turnos en consecuencia. Es una consulta rápida, no un sistema que gestionar.',
    ...
    'start.what.item1': '<strong>Previsiones diarias:</strong> predicciones de demanda para los próximos 14 días, entregadas a las 7.',
